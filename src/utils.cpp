...
{
    switch (type) {
    case mdns_record_type::MDNS_RECORDTYPE_PTR:
        return "PTR";
    case mdns_record_type::MDNS_RECORDTYPE_SRV:
        return "SRV";
    case mdns_record_type::MDNS_RECORDTYPE_A:
        return "A";
    case mdns_record_type::MDNS_RECORDTYPE_AAAA:
        return "AAAA";
    case mdns_record_type::MDNS_RECORDTYPE_TXT:
        return "TXT";
    case mdns_record_type::MDNS_RECORDTYPE_ANY:
        return "ANY";
    default:
